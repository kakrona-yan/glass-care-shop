                ...
                <div id="supplierList" class="card-body collapse show">
                    ...
                    <div class="tab-content">
                        <div id="addsupplier" class="tab-pane active">
                                <form class="form-main" action="{{route('category.update', $category->id)}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                        ...
                                        <div class="form-group select-group">
                                            ...
                                            <select class="form-control {{ $errors->has('category_type') ? ' is-invalid' : '' }}" 
                                                ...
                                                @foreach($categoryType as $key => $name)
                                                    <option value="{{ $key }}" {{ $key = $category->category_type ? 'selected' : '' }}>{{ $name }}</option>
                                                @endforeach
                                            </select>
