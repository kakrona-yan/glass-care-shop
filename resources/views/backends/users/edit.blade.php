...
<div id="user-list">
    ...
    <div class="row mb-2">
        <div class="col-12 tab-card">
            <!-- Circle Buttons -->
            <div class="card mb-4">
                <div id="userList" class="card-body collapse show">
                    <!-- Tab panes -->
                    <div class="tab-content">
                        <div id="adduser" class="tab-pane active">
                            <form class="form-main" action="{{route('user.update', $user->id)}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12 col-md-6 mb-2">
                                        <div class="form-group">
                                            <label for="email">{{__('user.list.name')}}:</label>
                                            <input type="emal" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" 
                                                placeholder="name"
                                                name="name"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input style="margin-top:-3px" class="form-check-input" type="radio" name="role" id="admin" value="1" {{old('role', $user->role) || empty($user->role) == '1' ? 'checked' : ''}}>
