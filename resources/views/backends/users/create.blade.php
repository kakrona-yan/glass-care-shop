                ...
                <div id="supplierList" class="card-body collapse show">
                    ...
                    <div class="tab-content">
                        <div id="addsupplier" class="tab-pane active">
                            <form class="form-main" action="{{route('users.store')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12 col-md-6 mb-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="gender" id="man" value="male" {{old('gender', $request->gender) == 'male' ? 'checked' : ''}}>
                                                <label class="form-check-label" for="man">{{__('users.form.man')}}</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="gender" id="woman" value="female" {{old('gender', $request->gender) == 'female' ? 'checked' : ''}}>
                                ...
                                <div class="form-group w-50 d-inline-flex">
                                    <button type="submit" class="btn btn-primary w-25 mr-2">{{__('button.add')}}</button>
